...
public class MaxLevelOrMinLengthStopConditionComponent extends AbstractStopConditionComponent {
  ...
  public MaxLevelOrMinLengthStopConditionComponent() {
    super("Max level or min length stop condition");
